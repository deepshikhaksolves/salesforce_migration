...
class ContractPlan(models.Model):
    ...
    downgrade_condition  = fields.Selection([('does not have','does not have'),('In promoting an employee','In promoting an employee'),('On the anniversary of the Contract','On the anniversary of the Contract'),('At the end of the campaign','At the end of the campaign')],'Downgrade Condition')
    ...
    upgrade_condition       = fields.Selection([('does not have','does not have'),('In promoting an employee','In promoting an employee'),('On the anniversary of the Contract','On the anniversary of the Contract'),('At the end of the campaign','At the end of the campaign')],'Upgrade Condition')

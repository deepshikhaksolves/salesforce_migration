...
class QuoteLineItem(models.Model):
    ...
    accredited_network__c = fields.Many2one('accredited_network', string="Accredited Network",track_visibility='onchange')
    copay__c = fields.Selection([('WITH_COPAY','With co-participation'),('WITHOUT_COPAY','No Co-participation')],'Co-participation',track_visibility='onchange')
    ...
    requested_proposal__c = fields.Boolean('Requested proposal',track_visibility='onchange')
    ...
    UnitPrice = fields.Float('Sales Price', digits=(16, 2),track_visibility='onchange')

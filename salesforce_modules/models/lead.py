...
class SalesforceLead(models.Model):
    ...
    actual_birth_policy_c = fields.Selection(
        [('January', 'January'), ('February', 'February'), ('March', 'March'), ('April', 'April'), ('May', 'May'),
         ('June', 'June'), ('July', 'July'), ('August', 'August'), ('September', 'September'), ('October', 'October'),
         ('November', 'November'), ('December', 'December')], 'Actual Birth Policy',track_visibility='onchange')

    actual_carrier_c = fields.Many2one('account.account', string='Actual Carrier',track_visibility='onchange')

    actual_invoice_c = fields.Float('Actual Invoice', digits=(16, 2),track_visibility='onchange')
    actual_lifes_c = fields.Float('Actual Lifes', digits=(18, 0),track_visibility='onchange')
    ...
    actual_birth_policy_order_c = fields.Text('Current Order Policy Anniversary',track_visibility='onchange')
    AnnualRevenue = fields.Float('Annual Revenue', digits=(18, 0),track_visibility='onchange')

    Business_Name_c = fields.Char('Business Name', size=255,track_visibility='onchange')
    ...
    Company_Segmentation_c = fields.Selection(
    ...
    unqualified_account_source_c = fields.Many2one('account.account', string='Disqualification Account',track_visibility='onchange')
    converted_c = fields.Char('Converted',track_visibility='onchange')
    ...
    CurrentGenerators_c = fields.Char('Current Generator(s)', size=100,track_visibility='onchange')
    Date_of_Birth_c = fields.Date('Birth date',track_visibility='onchange')
    ...
    extension_number_c = fields.Float('Extension Number', digits=(10, 0),track_visibility='onchange')
    Fax = fields.Char('Fax',track_visibility='onchange')
    HasOptedOutOfFax = fields.Boolean('Fax Opt Out',track_visibility='onchange')
    Financial_Group_c = fields.Char('Financial Group', size=255,track_visibility='onchange')
    Mailing_Origin_c = fields.Char('Mailing Source', size=255,track_visibility='onchange')
    Nominative_c = fields.Boolean('Indicated',track_visibility='onchange')
    ...
    Lead_c = fields.Char('Lead',track_visibility='onchange')
    ...
    loss_comment_c = fields.Char('Loss Comment', size=255,track_visibility='onchange')
    # loss_reason__c         already in odoo i.e (lost_reason)
    mailing_file_name_c = fields.Char('Mailing File Name', size=255,track_visibility='onchange')
    ...
    NumberofLocations_c = fields.Float('Number of Locations', digits=(3, 0),track_visibility='onchange')
    ...
    Owner_Division_c = fields.Char('Owner Division', size=255,track_visibility='onchange')
    ...
    Primary_c = fields.Selection([('No', 'No'), ('Yes', 'Yes')], 'Primary',track_visibility='onchange')
    ProductInterest_c = fields.Selection(
    ...
    rescue_date_c = fields.Date('Rescue Date',track_visibility='onchange')
    secondary_mobile_phone_c = fields.Char('Secondary Mobile Phone',track_visibility='onchange')
    Sales_Channel_c = fields.Many2one('channel_segmentation', string='Channel Segmentation',track_visibility='onchange')
    secondary_phone_c = fields.Char('Secondary phone',track_visibility='onchange')

    telemarketing_c = fields.Selection(
    ...
    Workflow_Configuration_c = fields.Many2one('workflow_configuration', string='Workflow Configuration',track_visibility='onchange')

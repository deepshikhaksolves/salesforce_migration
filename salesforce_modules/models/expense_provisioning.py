...
class ExpenceProvisioning(models.Model):
    ...
    Participation = fields.Selection(
        [('Consultant', 'Consultant'), ('Consultant', 'Consultant'), ('Indicator', 'Indicator'),
         ('Pre-consultant', 'Pre-consultant'), ('Association', 'Association'), ('Business partner', 'Business partner'),
         ('Manager', 'Manager'), ('Relationship', 'Relationship')], 'Participation')
    ...
    Status = fields.Selection(
        [('Pending', 'Pending'), ('Accrued expense', 'Accrued expense'), ('Approved', 'Approved')], 'Status')

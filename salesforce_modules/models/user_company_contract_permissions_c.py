...
class UserAgreement(models.Model):
    ...
    financial_group_c = fields.Many2one('financial_group', string='Financial Group',track_visibility='onchange')
    id_c = fields.Char(string='ID',track_visibility='onchange')

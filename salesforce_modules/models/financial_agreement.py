...
class FinancialAgreement(models.Model):
    ...
    status = fields.Selection([('Under Analysis', 'Under Analysis'), ('In Technical Approval', 'In Technical Approval'),
                               ('provisioned', 'provisioned'), ('Manually Provisioned', 'Manually Provisioned'),

...
class SalesforceOpprtunity(models.Model):
    ...
    complex_test = fields.Text('Complex Test',size=255)
    ...
    contributory_description = fields.Text('Contributory Description',size=255)
    ...
    emergency_room_appointment = fields.Text('Emergency Room Appointment',size=255)
    expected_revenue = fields.Float('Expected Revenue',digits=(16,2))
    external_id = fields.Text('External Id',size=255)

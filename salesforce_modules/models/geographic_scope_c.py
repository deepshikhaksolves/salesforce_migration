...
class GeographicScope(models.Model):
    ...
    _rec_name = 'Abbreviation_c'

    Abbreviation_c = fields.Char('Abbreviation', size=50)
    Name = fields.Char('ANS scope', size=80)
    Geographic_Scope_ID_c = fields.Integer('Scope ID')
    # CreatedById already in odoo
    Geographic_Scope_tnk_c = fields.Char('Geographic Scope tnk', size=80)

...
class EventControl(models.Model):
    ...
    name = fields.Char('Event', size=80,required=True)
    ...
    pre_consultant_current_user = fields.Char('Pre Consultant Current User',required=True)
    Rescheduled = fields.Boolean('Rescheduled')
    Start_Date = fields.Datetime('Start Date')
    Visit = fields.Char('Visit',required=True)
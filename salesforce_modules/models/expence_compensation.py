...
class ExpenceCompensation(models.Model):
    ...
    Percentage_of_Provisioned_Comission = fields.Float(string='Percentage of the Provisioned Commission',digits=(16,2))
    ...
    Status                  = fields.Selection([('provisioned','provisioned'),('Delete','Delete'),('Paid out','Paid out'),('Called off','Called off')],'Status')
